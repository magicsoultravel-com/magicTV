/**
 * One-shot HLS/native stream → JPEG thumbnail capture.
 * Intentionally separate from playback HLS config (tiny buffers, first frame).
 */
import { loadHlsLibrary, isHlsUrl, canPlayNativeHls } from '../tvHls.js';

/** Idle overall / media-ready budgets (top-of-list grabs). */
export const CAPTURE_BUDGET_MS = 5000;
